...
export default function SectionFive() {
  ...
  return (
    <Stack direction='column' alignItems='center' sx={{ maxWidth: '1200px', margin: '0 auto', padding: isMobile && '20px 0px' }}>
      ...
      <Typography variant="h2" fontWeight={600} fontFamily={'"Raleway", sans-serif'} color="white" fontSize={isMobile ? '20px' : '30px'} textAlign={'center'} pb={6}>Here's a sneak peak of</Typography>
      <Typography className={myFont.className} variant="h2" fontWeight={600} color="white" fontSize={isMobile ? '25px' : '60px'} textAlign={'center'}>Our Special Day's Schedule</Typography>
      {!isMobile ? (
