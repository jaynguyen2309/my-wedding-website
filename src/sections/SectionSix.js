  ...
  return (
    <Stack spacing={3} direction='row' justifyContent='space-between' sx={{ maxWidth: '1200px', margin: '0 auto' }}>
      <Box display={'flex'} flexDirection={'column'} gap={5} pt={10}>
        <Typography variant="h1" fontWeight={500} color={'#590112'} className={myFont.className} mb={'100px'}>Location</Typography>
      ...
      <img src="/img/sheraton.jpg" alt="map" style={{ maxHeight: '700px', height: '100%' , padding: '50px'}} />
    </Stack>
  )
}